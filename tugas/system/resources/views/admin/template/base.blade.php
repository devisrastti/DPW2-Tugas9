...
<head>
  ...
  <link rel="stylesheet" href="{{ url('public/admin') }}/vendors/datatables.net-bs4/dataTables.bootstrap4.css">
...
<body>
  ...
  <script src="{{ url('public/admin') }}/js/Chart.roundedBarCharts.js"></script>
